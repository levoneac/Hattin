...
namespace Hattin
{
    ...
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            perft.PrintTotalMovesPerBranchTillDepth(3, "8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 1");  //8/2p5/3p4/KP5r/1R3p1k/8/4P1P1/8 w - - 0 1 (BlackKing on H4 cannot be captured by WhiteRook from B4)
